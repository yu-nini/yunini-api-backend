...
@Aspect
@Component
public class AuthOrMemberInterceptor {
    ...
    public Object doInterceptor(ProceedingJoinPoint joinPoint, AuthOrMemberCheck authCheck) throws Throwable {
        ...
        if (StringUtils.isNotBlank(mustRole)) {
            ...
            // 必须有管理员权限
            if (UserRoleEnum.ADMIN.equals(mustUserRoleEnum) || UserRoleEnum.MEMBER.equals(mustUserRoleEnum)) {
